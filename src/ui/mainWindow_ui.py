...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Layout_controls.addWidget(self.cBox_Speed, 2, 0, 1, 1)
        self.pButton_Stop = QtGui.QPushButton(self.centralwidget)
        self.pButton_Stop.setObjectName(_fromUtf8("pButton_Stop"))
        self.Layout_controls.addWidget(self.pButton_Stop, 2, 2, 1, 1)
        ...
        self.Layout_controls.addWidget(self.pButton_Start, 0, 2, 1, 1)
        ...
        self.Layout_controls.addWidget(self.sBox_Samples, 0, 1, 1, 1)
        ...
        self.Layout_controls.addWidget(self.chBox_export, 2, 1, 1, 1)
